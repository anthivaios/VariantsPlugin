...
using SpecFlow.Contrib.Variants.UnitTests;

namespace VariantsPlugin.UnitTests
{
    public class TestBase
    {
        private IUnitTestGeneratorProvider _unitTestGeneratorProvider;

        protected ReqnrollDocument CreateSpecFlowDocument(string document)
        {
        ...
        private IFeatureGenerator FeatureGenerator(CodeDomHelper codeDomHelper)
        {
            ...
            return new FeatureGeneratorExtended(_unitTestGeneratorProvider, codeDomHelper, runtimeConfiguration, dr, SampleFeatureFile.Variant, config);
        }
